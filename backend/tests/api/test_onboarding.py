...
class TestPreferencesRequest:
    ...
    def test_exceeds_max_raises(self) -> None:
        genres = [
            "fantasia", "sci-fi", "romance", "terror", "misterio-thriller",
            "biografia", "autoajuda", "poesia", "hq-manga", "classicos",
            "jovem-adulto",
        ]
...
class TestUpdatePreferences:
    ...
    async def test_success(self) -> None:
        ...
        await update_preferences(
            db=mock_db, user=user, preferred_genres=["fantasia", "terror"]
        )

        assert user.preferred_genres == ["fantasia", "terror"]
...
class TestOnboardingPreferencesEndpoint:
    ...
    async def test_success(self) -> None:
        ...
        mock_db = AsyncMock()
        mock_user = _make_user()
        body = PreferencesRequest(preferred_genres=["fantasia", "terror"])
