...
api_router.include_router(group_messages_router, prefix="/groups/{group_id}/messages", tags=["chat"])
...
api_router.include_router(meetings_standalone_router, prefix="/meetings", tags=["meetings"])
api_router.include_router(
...
api_router.include_router(media_router, prefix="/groups/{group_id}/media/upload", tags=["media"])
api_router.include_router(chat_stream_router, prefix="/groups/{group_id}/chat/stream", tags=["chat-stream"])
api_router.include_router(stats_group_router, prefix="/groups/{group_id}/stats", tags=["stats"])
api_router.include_router(badges_group_router, prefix="/groups/{group_id}/badges", tags=["badges"])
api_router.include_router(quotes_group_router, prefix="/groups/{group_id}/quotes", tags=["quotes"])
api_router.include_router(shelf_group_router, prefix="/groups/{group_id}/shelf", tags=["shelf"])
...
api_router.include_router(wrapped_group_router, prefix="/groups/{group_id}/wrapped", tags=["wrapped"])
