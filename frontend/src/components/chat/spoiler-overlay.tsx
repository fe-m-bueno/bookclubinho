      ...
      <div className="relative">
        ...
        <AnimatePresence>
          <motion.button
            ...
            className="absolute inset-0 flex min-h-[44px] flex-col items-center justify-center gap-1.5 rounded-xl backdrop-blur-[8px] bg-sage-200/60 dark:bg-sage-800/60 transition-colors hover:bg-sage-200/70 dark:hover:bg-sage-800/70 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
          >
            <EyeOff className="size-5 text-sage-800 dark:text-sage-200" aria-hidden="true" />
